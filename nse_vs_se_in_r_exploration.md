...
#calling f()
g()
## <environment: 0x0000000006f44028>
## <environment: 0x0000000006f44028>
...
g1()
## <environment: 0x0000000007878cd0>
...
## <environment: 0x0000000007764cd0>
## <environment: R_GlobalEnv>
## [1] "--> scramble (current. env, parent.frame)"
## <environment: 0x0000000007762fe8>
## <environment: 0x0000000007764cd0>
## [1] "--> subset2 (current. env, parent.frame)"
## <environment: 0x0000000007760390>
## <environment: 0x0000000007764cd0>
## condition
## Error in eval(expr, envir, enclos): object 'a' not found
